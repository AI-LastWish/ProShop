  ...
  return (
    <>
      ...
      {loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> :
        <Row>
          <Col md={6}>
            {/* fluid: keep image inside container */}
          ...
          <Col md={3}>
            <Card>
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                  <Button onClick={addToCartHandler} className='btn-block full-width' type='button' disabled={product.countInStock === 0}>Add To Cart</Button>
                </ListGroup.Item>
              </ListGroup>
            </Card>
          </Col>
